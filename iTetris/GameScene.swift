...
// Set the lowest speed of the shapes.
...
class GameScene: SKScene {
    ...
    // Declare the closure.
    // Learn more here: https://developer.apple.com/library/prerelease/ios/documentation/swift/conceptual/swift_programming_language/Closures.html
    var tick:(() -> ())?
    ...
    override func update(currentTime: CFTimeInterval) {
        ...
        // The "!" makes sure lastTick is defined before we access it because is an optional variable.
        var timePassed = lastTick!.timeIntervalSinceNow * -1000.0
        if timePassed > tickLengthMillis {
            lastTick = NSDate.date()
            // By adding "?" before calling the method swift check if the tick exists.
            tick?()
        }
    }
